    ...
    public function index()
    {
        ...
        if($carts_amount>0)
        {
         ...
         if($coupon_code!=NULL)
         {
            ...
            $validate=DB::table('coupons')->where('code',$coupon_code)->value('valid_until');
        ...
        return view('pages.cart', compact('carts','total_price','discount_price','without_discount_price','extra_charge','total_extra_charge'));
    }
