...
@section('container')
              ...
              <div class="row">
                <div class="col-12 text-end mb-4" style="display: flex; justify-content: flex-end;">
                            ...
                            <div class="preview-item border-bottom">
                              <div class="preview-thumbnail">
                                <div class="preview-icon bg-primary">
                                  <img class="img-xs" src="{{ Storage::url($item->image) }}" alt="">
                                </div>
                              </div>
                              <div class="preview-item-content d-sm-flex flex-grow">
                                <div class="flex-grow">
                                  <h6 class="preview-subject">{{  $item->name }}</h6>
                                  <p class="text-muted mb-0">Rating : {{ number_format($item->avg_rating, 1) }}</p>
                                </div>
                                <div class="me-auto text-sm-right pt-2 pt-sm-0">
                                  <p class="text-muted">{{  $item->voter_count }} Votes</p>
                                </div>
                              </div>
                            </div>
                            @endforeach
