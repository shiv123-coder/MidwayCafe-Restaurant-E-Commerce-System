...
<div class="card-group">
  <div class="card">
    <img src="{{ Storage::url($customize_theme->image1) }}" class="card-img-top" alt="...">
    <div class="card-body">
  ...
  <div class="card" style="margin-left:20px;">
    <img src="{{ Storage::url($customize_theme->image2) }}" class="card-img-top" alt="...">
    <div class="card-body">
  ...
  <div class="card"  style="margin-left:20px;">
    <img src="{{ Storage::url($customize_theme->image3) }}" class="card-img-top" alt="...">
    <div class="card-body">
...
<div class="card mb-3">
  <img src="{{ Storage::url('images/about-video-bg.jpg') }}" class="card-img-top" alt="...">
  <div class="card-body">
