		  	...
		  	<div class="span8 well invoice-body">
		  		<table class="table table-bordered" id="customers" style="border:2px solid;margin-left:20px;margin-right:20px !important;width:95%!important;">
					...
					<tr style="border:2px solid;">
                      ...
                      <td style="margin-left:20px;">{{ $product->subtotal }} INR</td>
						</tr>
                    @endforeach
					...
					<tr style="border:2px solid;">
						...
						<td style="margin-left:20px;"></td>
                      <td style="margin-left:20px;">{{ $charge->price }} INR</td>
						</tr>
                    @endforeach
...
<tr>
							...
							<td><strong>{{  $without_discount_price }} INR</strong></td>
						</tr>
            <tr><td colspan="4"></td></tr>
<tr>
							<td colspan="2">&nbsp;</td>
							<td><strong>Discount</strong></td>
							<td><strong>{{  $discount_price }} INR</strong></td>
						</tr>
            <tr><td colspan="4"></td></tr>
<tr>
            <tr><td colspan="4"></td></tr>
        ...
        <br>
          ...
          <div class="span3" style="font-size:16px;">
            ...
            <br>
  	    	...
  	    	<div class="span3">
  		        <strong>Email:</strong> <a href="shivashankrmali5@gmail.com">shivashankrmali5@gmail.com</a>
  	    	</div>
