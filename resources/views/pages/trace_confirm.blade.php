...
<div class="row">
    <div class="column">
        <img src="{{ Storage::url('images/package.png')}}" height="100px" weight="100px" alt="">
    </div>

    <div class="column">
        @if($order->status == "Cancelled")
            <img src="{{ Storage::url('images/cancel.jpg')}}" style="margin-top: !important;" height="50px" weight="50px"  alt="">
            <h1 style= "color:Gray;padding-top:10px !important;" class="border2"></h1>
        @endif

        @if($order->status == "Processed" || $order->status == "Delivered")
            <img src="{{ Storage::url('images/right.png')}}" style="margin-top:-15px !important;" height="50px" weight="50px"  alt="">
    ...
    <div class="column">
        <img src="{{ Storage::url('images/delivery.png')}}" height="100px" weight="100px"  alt="">
    </div>

    <div class="column">
        @if($order->status == "Processed")
            <h6 id="count_down" style="padding-top:25px;color:Red;padding-bottom:10px;">(Remaining : {{ $order->delivery_time }})</h6>
            <h1 style= "color:Gray;padding-top:10px !important;" class="border2"></h1>
            <input type="text" id="previous_time" style="display:none" value="{{ $order->delivery_time }}">
        @endif
    ...
    <div class="column">
        <img src="{{ Storage::url('images/order.png')}}" height="100px" weight="100px"  alt="">
    </div>
</div>
